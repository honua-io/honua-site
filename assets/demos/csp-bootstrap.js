...
(function () {
  ...
  try {
    ...
    // Malformed percent-encoding, a throwing getter, anything at all: treat it as a rejected
    // override and emit the canonical policy unchanged. Never fall through without a CSP.
    origin = null;
    policy = canonicalPolicy;
  }
