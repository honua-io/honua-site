...
This deployment publishes four SDK-owned flagships. The first three remain
...
The safe-agent example remains outside the deployed artifact tree until its own
publication workstream is complete.

## Integrity and provenance

Assets live below commit-pinned roots
`/assets/sdk-samples/0.1.0-beta.0/892873e/` and
`/assets/sdk-samples/0.1.0-beta.0/88dd067/`. The committed
